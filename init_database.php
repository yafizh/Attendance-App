...
$sql = "
    INSERT INTO employee_attendance_table (
        ...
        (null, 2, 1, 'SORE', CONCAT(CURRENT_DATE() - INTERVAL 1 DAY,' ',NULL)),
        (null, 3, 1, 'PAGI', CONCAT(CURRENT_DATE() - INTERVAL 1 DAY,' ',NULL)),
        (null, 3, 1, 'SORE', CONCAT(CURRENT_DATE() - INTERVAL 1 DAY,' ',NULL)),
        ...
        (null, 5, 1, 'SORE', CONCAT(CURRENT_DATE() - INTERVAL 1 DAY,' ',NULL)),
        (null, 6, 1, 'PAGI', CONCAT(CURRENT_DATE() - INTERVAL 1 DAY,' ',NULL)),
        (null, 6, 1, 'SORE', CONCAT(CURRENT_DATE() - INTERVAL 1 DAY,' ',NULL)),
        (null, 1, 1, 'PAGI', CONCAT(CURRENT_DATE(),' ',NULL)),
        (null, 1, 1, 'SORE', CONCAT(CURRENT_DATE(),' ',NULL)),
